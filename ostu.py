...
#    scale_down = oslide.level_downsamples[level]
    ...
    # Avoid directly processing the original image without magnification
    if level < 1:
        print(file_path)
        oslide.close()
        return
...
if __name__ == '__main__':
    input_folder = "/home1/svs_files/"
    mask_folder = "/home1/yuanzhe/Lung_Subtype/WSIMask"
    file_list = get_all_files(input_folder)
    file_list = [file for file in file_list if file.split('.')[-1] == 'svs']
    wsi_list_path = "/home1/yuanzhe/Lung_slide_table.txt"
